...
Новая система баннеров, повторок, опыта, 100-уровневых пропусков и нескольких
колод, а также подробная передача всех отложенных изменений и экономики:
[docs/collection-progression.md](docs/collection-progression.md).
