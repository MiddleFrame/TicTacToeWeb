...
Release 48 (0.7.8), with 11 networks, records 27.05% optimization, 27.16% obfuscation and 27.16% shrinking. The previous three-network release 47 recorded 38.12%, 38.35% and 38.35%. The threshold margin is now only 2.05 percentage points: always inspect the new AAB after dependency changes. These are embedded R8 measurements, not Play download-size or runtime RAM measurements.
