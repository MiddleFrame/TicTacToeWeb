...
const text = {
  ru: {
    progressOffline: "Нет связи с сервером. Прогресс сохраняется на устройстве и синхронизируется позже.",
  ...
  en: {
    progressOffline: "The server is unavailable. Progress is saved on this device and will sync later.",
