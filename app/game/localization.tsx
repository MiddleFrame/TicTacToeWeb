...
const text = {
  ru: {
    back: "Назад в меню", settings: "Настройки", options: "Параметры", playerName: "Имя игрока", language: "Язык", russian: "Русский", english: "English", sound: "Звук", soundOn: "Включён", soundOff: "Выключен", theme: "Тема", classic: "Светлая", dark: "Тёмная", googleAccount: "Google-аккаунт", googleConnect: "Привязать", googleConnected: "Привязан", googleConnecting: "Подключаем", googleFailed: "Повторить",
