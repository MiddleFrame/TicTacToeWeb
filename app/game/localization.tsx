...
const text = {
  ru: {
    back: "Назад в меню", settings: "Настройки", options: "Параметры", playerName: "Имя игрока", language: "Язык", russian: "Русский", english: "English", sound: "Звук", soundOn: "Включён", soundOff: "Выключен", theme: "Тема", classic: "Светлая", dark: "Тёмная", testing: "Тестирование", testingHint: "Временные инструменты для проверки магазина и открытия карт", currentBalance: "Баланс", addCoins: "Добавить монеты", resetCards: "Сбросить открытые карты",
    ...
    turn: "Ход", endTurn: "Конец хода", replaceCard: "Заменить карту", hand: "Карты в руке", pause: "Пауза", resume: "Продолжить", toMenu: "В меню", mainMenu: "В главное меню", newMatch: "Новый матч", nextRound: "Следующий раунд", matchComplete: "Матч завершён", round: "Раунд", roundComplete: "Раунд завершён", scoreByRounds: "Итог по раундам", nextBoard: "Следующее поле", mana: "мана",
    ...
    connectFailed: "Не удалось подключиться", waitingOpponent: "Ждём соперника", connecting: "Подключаемся к Photon", searchingOpponent: "Ищем соперника", roomCreated: "Комната готова. Матч начнётся, когда подключится второй игрок.", searchingMatch: "Ищем соперника в общем пуле игроков.", returnMenu: "Вернуться в меню",
  },
  en: {
    back: "Back to menu", settings: "Settings", options: "Options", playerName: "Player name", language: "Language", russian: "Русский", english: "English", sound: "Sound", soundOn: "On", soundOff: "Off", theme: "Theme", classic: "Light", dark: "Dark", testing: "Testing", testingHint: "Temporary tools for testing the store and card reveals", currentBalance: "Balance", addCoins: "Add coins", resetCards: "Reset unlocked cards",
    ...
    turn: "Turn", endTurn: "End turn", replaceCard: "Replace card", hand: "Cards in hand", pause: "Pause", resume: "Continue", toMenu: "Menu", mainMenu: "Main menu", newMatch: "New match", nextRound: "Next round", matchComplete: "Match complete", round: "Round", roundComplete: "Round complete", scoreByRounds: "Round score", nextBoard: "Next board", mana: "mana",
    ...
    connectFailed: "Connection failed", waitingOpponent: "Waiting for an opponent", connecting: "Connecting to Photon", searchingOpponent: "Finding an opponent", roomCreated: "The room is ready. The match starts when another player joins.", searchingMatch: "Searching the shared player pool.", returnMenu: "Return to menu",
  },
} as const;
